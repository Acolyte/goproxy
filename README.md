...
![Status](https://github.com/Acolyte/goproxy/workflows/Go/badge.svg)
[![GoDoc](https://pkg.go.dev/badge/github.com/Acolyte/goproxy)](https://pkg.go.dev/github.com/Acolyte/goproxy)
[![Go Report](https://goreportcard.com/badge/github.com/Acolyte/goproxy)](https://goreportcard.com/report/github.com/Acolyte/goproxy)
...
You also have to [trust](https://github.com/Acolyte/goproxy/blob/master/examples/customca/README.md)
...
### Let's start
```go
import "github.com/Acolyte/goproxy"
```
